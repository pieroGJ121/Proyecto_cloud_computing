...
from models import db, Review, setup_db
...
def create_app(test_config=None):
    ...
    def obtain_reviews_from_user():
        ...
        return jsonify({"success": True, "reviews": reviews_serialized}), 200
    ...
    def update_review(id):
        ...
        if returned_code == 404:
            return (
                jsonify({"success": False, "message": "There is no review"}),
                returned_code,
            )
            ...
            return (
                jsonify({"success": True, "message": "Review updated successfully"}),
                returned_code,
            )
    ...
    def delete_review(id):
        ...
        if returned_code == 404:
            ...
            return (
                jsonify({"success": True, "message": "Review deleted successfully"}),
                returned_code,
            )
